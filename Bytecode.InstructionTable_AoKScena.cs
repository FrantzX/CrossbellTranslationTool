...
{
	static class InstructionTable_AoKScena
	{
		static InstructionTable_AoKScena()
		{
			...
			BlurSwitch = new InstructionDefinition(0x14, "BlurSwitch", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16, OperandType.UInt32, OperandType.UInt16, OperandType.Byte, OperandType.UInt16);
			CancelBlur = new InstructionDefinition(0x15, "CancelBlur", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt32);
			OP_16 = new InstructionDefinition(0x16, "OP_16", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			...
			OP_B2 = new InstructionDefinition(0xB2, "OP_B2", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16);
			OutputDebugInt = new InstructionDefinition(0xB3, "OutputDebugInt", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_B4 = new InstructionDefinition(0xB4, "OP_B4", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_B5 = new InstructionDefinition(0xB5, "OP_B5", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.UInt16);
			LoadOps = new InstructionDefinition(0xB6, "LoadOps", InstructionFlags.None, DefaultBuildInstruction);
			ModifyEventFlags = new InstructionDefinition(0xB7, "ModifyEventFlags", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte, OperandType.UInt16);
			PlayMovie = new InstructionDefinition(0xB8, "PlayMovie", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.String, OperandType.UInt16, OperandType.UInt16);
			OP_B9 = new InstructionDefinition(0xB9, "OP_B9", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			ReplaceBGM = new InstructionDefinition(0xBA, "ReplaceBGM", InstructionFlags.None, DefaultBuildInstruction, OperandType.Int16, OperandType.Int16);
			OP_BC = new InstructionDefinition(0xBC, "OP_BC", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			UseItem = new InstructionDefinition(0xBD, "UseItem", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16, OperandType.UInt16);
			OP_BE = new InstructionDefinition(0xBE, "OP_BE", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.UInt16);
			OP_BF = new InstructionDefinition(0xBF, "OP_BF", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte);
			SetChrChipPat = new InstructionDefinition(0xC0, "SetChrChipPat", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte, OperandType.UInt32);
			LoadChrChipPat = new InstructionDefinition(0xC2, "LoadChrChipPat", InstructionFlags.None, DefaultBuildInstruction);
			OP_C3 = new InstructionDefinition(0xC3, "OP_C3", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.Byte, OperandType.Int32, OperandType.Int32, OperandType.Int32, OperandType.Int32, OperandType.Int32, OperandType.Int32);
			OP_C4 = new InstructionDefinition(0xC4, "OP_C4", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte, OperandType.UInt16, OperandType.UInt16);
			MiniGame = new InstructionDefinition(0xC5, "MiniGame", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32);
			OP_C7 = new InstructionDefinition(0xC7, "OP_C7", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte);
			OP_C9 = new InstructionDefinition(0xC9, "OP_C9", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.UInt32);
			CreatePortrait = new InstructionDefinition(0xCA, "CreatePortrait", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt16, OperandType.UInt32, OperandType.Byte, OperandType.String);
			OP_CB = new InstructionDefinition(0xCB, "OP_CB", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32);
			OP_CC = new InstructionDefinition(0xCC, "OP_CC", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte, OperandType.Byte);
			PlaceName2 = new InstructionDefinition(0xCD, "PlaceName2", InstructionFlags.None, DefaultBuildInstruction, OperandType.Int16, OperandType.Int16, OperandType.String, OperandType.Byte, OperandType.Int16);
			PartySelect = new InstructionDefinition(0xCE, "PartySelect", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_CF = new InstructionDefinition(0xCF, "OP_CF", InstructionFlags.None, BuildInstruction_0xCF);
			MenuCmd = new InstructionDefinition(0xD0, "MenuCmd", InstructionFlags.None, BuildInstruction_MenuCmd);
			OP_D1 = new InstructionDefinition(0xD1, "OP_D1", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16);
			OP_D2 = new InstructionDefinition(0xD2, "OP_D2", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Expression);
			OP_D3 = new InstructionDefinition(0xD3, "OP_D3", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16, OperandType.Byte, OperandType.String);
			OP_D4 = new InstructionDefinition(0xD4, "OP_D4", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt32, OperandType.UInt32);
			OP_D5 = new InstructionDefinition(0xD5, "OP_D5", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32);
			LoadChrToIndex = new InstructionDefinition(0xD6, "LoadChrToIndex", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt32, OperandType.Byte);
			OP_D7 = new InstructionDefinition(0xD7, "OP_D7", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_D8 = new InstructionDefinition(0xD8, "OP_D8", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte);
			OP_D9 = new InstructionDefinition(0xD9, "OP_D9", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte);
			OP_DA = new InstructionDefinition(0xDA, "OP_DA", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_DC = new InstructionDefinition(0xDC, "OP_DC", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_DD = new InstructionDefinition(0xDD, "OP_DD", InstructionFlags.None, DefaultBuildInstruction);
			OP_DE = new InstructionDefinition(0xDE, "OP_DE", InstructionFlags.None, DefaultBuildInstruction, OperandType.String);
			LoadAnimeChip = new InstructionDefinition(0xDF, "LoadAnimeChip", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16, OperandType.Byte, OperandType.Byte);
			OP_E0 = new InstructionDefinition(0xE0, "OP_E0", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte);
			OP_E2 = new InstructionDefinition(0xE2, "OP_E2", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_E3 = new InstructionDefinition(0xE3, "OP_E3", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32);
			OP_E4 = new InstructionDefinition(0xE4, "OP_E4", InstructionFlags.None, BuildInstruction_0xE4);
			OP_E5 = new InstructionDefinition(0xE5, "OP_E5", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_E6 = new InstructionDefinition(0xE6, "OP_E6", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.Byte, OperandType.Byte, OperandType.Byte, OperandType.Byte, OperandType.Byte, OperandType.UInt32);
			OP_E7 = new InstructionDefinition(0xE7, "OP_E7", InstructionFlags.None, DefaultBuildInstruction);
			OP_E8 = new InstructionDefinition(0xE8, "OP_E8", InstructionFlags.None, DefaultBuildInstruction);
			ShowSaveClearMenu = new InstructionDefinition(0xE9, "ShowSaveClearMenu", InstructionFlags.None, DefaultBuildInstruction);
			OP_F0 = new InstructionDefinition(0xF0, "OP_F0", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.UInt16);
			OP_F3 = new InstructionDefinition(0xF3, "OP_F3", InstructionFlags.None, DefaultBuildInstruction, OperandType.Int32);
			OP_F4 = new InstructionDefinition(0xF4, "OP_F4", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_FA = new InstructionDefinition(0xFA, "OP_FA", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16);
			OP_FB = new InstructionDefinition(0xFB, "OP_FB", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16, OperandType.Byte);
			OP_FC = new InstructionDefinition(0xFC, "OP_FC", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16);
			OP_FD = new InstructionDefinition(0xFD, "OP_FD", InstructionFlags.None, DefaultBuildInstruction, OperandType.UInt16, OperandType.UInt16);
			OP_FE = new InstructionDefinition(0xFE, "OP_FE", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte);
			OP_FF = new InstructionDefinition(0xFF, "OP_FF", InstructionFlags.None, DefaultBuildInstruction, OperandType.Byte, OperandType.UInt32, OperandType.UInt32, OperandType.UInt32);
		}
		...
		static void BuildInstruction_0xCF(DisassemblyState state)
		{
			Assert.IsNotNull(state, nameof(state));
		...
		static void BuildInstruction_0xE4(DisassemblyState state)
		{
			Assert.IsNotNull(state, nameof(state));
		...
		public static InstructionDefinition OP_B4 { get; }
		public static InstructionDefinition OP_B5 { get; }
		...
		public static InstructionDefinition OP_B9 { get; }
		...
		public static InstructionDefinition OP_BE { get; }
		public static InstructionDefinition OP_BF { get; }
		public static InstructionDefinition SetChrChipPat { get; }
		public static InstructionDefinition LoadChrChipPat { get; }
		public static InstructionDefinition OP_C3 { get; }
		public static InstructionDefinition OP_C4 { get; }
		...
		public static InstructionDefinition OP_CB { get; }
		public static InstructionDefinition OP_CC { get; }
		...
		public static InstructionDefinition OP_D4 { get; }
		...
		public static InstructionDefinition OP_D9 { get; }
		public static InstructionDefinition OP_DA { get; }
		public static InstructionDefinition OP_DC { get; }
		public static InstructionDefinition OP_DD { get; }
		...
		public static InstructionDefinition OP_E7 { get; }
		public static InstructionDefinition OP_E8 { get; }
		public static InstructionDefinition ShowSaveClearMenu { get; }
		public static InstructionDefinition OP_F0 { get; }
		public static InstructionDefinition OP_F3 { get; }
		public static InstructionDefinition OP_F4 { get; }
		...
		public static InstructionDefinition OP_FE { get; }
		public static InstructionDefinition OP_FF { get; }
	}
}
